    ...
    <>
      ...
      >
        {clients.map((client, i) => (
          ...
          >
            <span
              className="client-mark block text-2xl lg:text-3xl font-semibold tracking-[0.1em] text-foreground/90 cursor-default transition-[opacity,color,letter-spacing,font-weight,text-shadow] duration-500 group-hover/field:opacity-25 hover:!opacity-100 hover:text-accent hover:tracking-[0.2em] hover:font-bold hover:[text-shadow:0_0_22px_hsl(43_90%_65%_/_.5)]"
              style={{
