        ...
        >
          ...
          <div className="md:grid md:grid-cols-12 md:gap-x-12 md:gap-y-24 lg:gap-y-32">
            <Figure
              ...
              className="md:col-start-1 md:col-span-6 lg:col-span-5 md:row-start-1 reveal reveal--left"
            />

            <div className="md:col-start-8 lg:col-start-7 md:col-span-5 lg:col-span-4 md:row-start-1 self-start mt-12 md:mt-0 reveal reveal--right reveal-delay-1">
