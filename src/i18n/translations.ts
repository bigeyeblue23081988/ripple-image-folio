...
export const translations = {
  en: {
    ...
    hero: {
      ...
      ctaLocation: "See the filming location",
      ctaGuesthouse: "See the guesthouse",
      ctaProduction: "Discuss a production",
      ctaBookLocation: "Book a filming location",
      ctaBookGuesthouse: "Book the guesthouse",
      overlayLine1: "A production house in Ghent",
      overlayLine2: "A place where people and stories meet.",
    },
    showreel: {
      caption: "Showreel",
      sub: "Bigeye Blue in 30 seconds",
      soundOn: "Sound on",
      soundOff: "Sound off",
  ...
  nl: {
    ...
    hero: {
      ...
      ctaLocation: "Bekijk de filmlocatie",
      ctaGuesthouse: "Bekijk het gastenverblijf",
      ctaProduction: "Bespreek een productie",
      ctaBookLocation: "Boek een filmlocatie",
      ctaBookGuesthouse: "Boek het gastenverblijf",
